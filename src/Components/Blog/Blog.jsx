...
const Blog = ({ blog,handleAddToBookmarks,handleAddTimeToBookmarks }) => {
    // console.log(blog);
    const {cover,author,author_img,title,reading_time,posted_date,hashtag,id} = blog
    return (
        <div className='mb-20 space-y-4'>
            ...
            <button onClick={()=>handleAddTimeToBookmarks(reading_time,id)} className='text-green-700 border-b-2 border-green-700'>Mark As Read</button>
        </div>
    );
};
